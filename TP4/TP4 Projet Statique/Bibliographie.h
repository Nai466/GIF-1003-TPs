...
namespace biblio
{
  ...
  public:
    ...
    void supprimerReference (const std::string& p_identifiant); //méthode pour supprimer une reference
  ...
  private:
    ...
    std::vector<biblio::Reference*> m_vReferences; //vecteur qui permet de pointer sur les references.
