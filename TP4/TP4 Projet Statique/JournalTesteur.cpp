...
public:
  ...
  JournalValide () : f_JournalVal ("Hart", "A survey of source code management tools for programming courses ", 2011, "ISSN 1937-4771", "Journal of computing sciences in colleges ", 12, 45, 59) { }
