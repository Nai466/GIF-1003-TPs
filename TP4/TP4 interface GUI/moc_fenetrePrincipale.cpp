...
QT_MOC_LITERAL(1, 18, 14), // "ajouterJournal"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 14), // "ajouterOuvrage"
QT_MOC_LITERAL(4, 49, 34) // "supprimerReferenceBibliograph..."

    },
    "fenetrePrincipale\0ajouterJournal\0\0"
    "ajouterOuvrage\0supprimerReferenceBibliographiques"
};
...
void fenetrePrincipale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ajouterJournal(); break;
        case 1: _t->ajouterOuvrage(); break;
        case 2: _t->supprimerReferenceBibliographiques(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
